...
class Analisi_campioni(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFile('stile_analisi_campioni_table', 'stile analisi_campioni_table', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_analisi_campioni', 'stile analisi_campioni', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_min_oriented_bbox', 'stile min_oriented_bbox', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_analisi_rilievo', 'stile analisi_rilievo', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
