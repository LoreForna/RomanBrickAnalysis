...
class Analisi_campioni(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFile('stile_analisi_campioni_table', 'percorso stile analisi_campioni_table', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_analisi_campioni', 'percorso stile analisi_campioni', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_min_oriented_bbox', 'percorso stile min_oriented_bbox', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
        self.addParameter(QgsProcessingParameterFile('stile_analisi_rilievo', 'percorso stile analisi_rilievo', behavior=QgsProcessingParameterFile.File, fileFilter='Tutti i File (*.*)', defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'STYLE': parameters['stile_min_oriented_bbox']
        }
        ...
        alg_params = {
            ...
            'STYLE': parameters['stile_analisi_rilievo']
        }
        ...
        alg_params = {
            ...
            'STYLE': parameters['stile_analisi_campioni_table']
        }
        ...
        alg_params = {
            ...
            'STYLE': parameters['stile_analisi_campioni']
        }
