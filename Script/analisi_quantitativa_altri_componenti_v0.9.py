"""
SCRIPT ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 0.9
"""
...
class Analisi(QgsProcessingAlgorithm):
    ...
    def _log_header(self, feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 0.9")
...
END''',
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Altri Componenti - Versione 0.9</h3>
