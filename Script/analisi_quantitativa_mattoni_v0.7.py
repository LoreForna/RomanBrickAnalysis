"""
SCRIPT ANALISI QUANTITATIVA MATTONI - VERSIONE 0.7
"""
...
class Analisi(QgsProcessingAlgorithm):
    ...
    def _log_header(self, feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA MATTONI - VERSIONE 0.7")
...
END''',
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Mattoni - Versione 0.7</h3>
