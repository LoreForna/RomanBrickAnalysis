"""
SCRIPT ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 0.6
"""
...
class Analisi(QgsProcessingAlgorithm):
    ...
    def _log_header(self, feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 0.6")
...
END''',
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Altri Componenti - Versione 0.6</h3>
