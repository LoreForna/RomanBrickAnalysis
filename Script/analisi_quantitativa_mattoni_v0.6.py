"""
SCRIPT ANALISI QUANTITATIVA MATTONI - VERSIONE 0.6
"""
...
class Analisi(QgsProcessingAlgorithm):
    ...
    def _log_header(self, feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA MATTONI - VERSIONE 0.6")
...
END'''
    ...
    def _create_final_stats_table(self, input_layer: str, context, feedback) -> Dict:
        ...
        field_mapping = self.create_field_mapping([
            ...
            ('to_real("parz_sum")', 'totale area mattoni parziali', 6, 0, 4),
            ('to_int("int_count")', 'num. mattoni interi', 2, 0, 0),
            ('to_real("int_sum")', 'totale area mattoni interi', 6, 0, 4),
            ('to_real("int_mean")', 'media area mattoni interi', 6, 0, 4),
...
END''',
        ...
        calc3 = processing.run('native:fieldcalculator', {
            ...
            'FIELD_TYPE': 0,
            'FORMULA': 'round(COALESCE("totale area mattoni interi", 0) + COALESCE("totale area mattoni parziali", 0), 4)',
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        calc4 = processing.run('native:fieldcalculator', {
            ...
            'FIELD_TYPE': 0,
            'FORMULA': 'round(COALESCE("area campione", 0) - COALESCE("totale area mattoni", 0), 4)',
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }, context=context, feedback=feedback, is_child_algorithm=True)
...
END''',
    ...
    def _create_output_tables(self, input_layer: str, parameters: Dict,
        ...
        table_fields = self.create_field_mapping([
            ...
            ('"totale area mattoni interi"', 'totale_area_mattoni_interi', 6, 0, 4),
            ('"media area mattoni interi"', 'media_area_mattoni_interi', 6, 0, 4),
            ('"num. mattoni parziali"', 'num_mattoni_parziali', 2, 0, 0),
            ('"totale area mattoni parziali"', 'totale_area_mattoni_parziali', 6, 0, 4),
            ...
            ('"totale area mattoni"', 'totale_area_mattoni', 6, 0, 4),
        ...
        geo_fields = self.create_field_mapping([
            ...
            ('"totale_area_mattoni_parziali"', 'totale_area_mattoni_parziali', 6, 0, 4),
            ('"num_mattoni_interi"', 'num_mattoni_interi', 2, 0, 0),
            ('"totale_area_mattoni_interi"', 'totale_area_mattoni_interi', 6, 0, 4),
            ('"media_area_mattoni_interi"', 'media_area_mattoni_interi', 6, 0, 4),
            ...
            ('"totale_area_mattoni"', 'totale_area_mattoni', 6, 0, 4),
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Mattoni - Versione 0.6</h3>
