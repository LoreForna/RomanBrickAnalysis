"""
SCRIPT ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 1.0
"""
...
class Analisi(QgsProcessingAlgorithm):
    ...
    def _log_header(self, feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA ALTRI COMPONENTI - VERSIONE 1.0")
...
END''',
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Altri Componenti - Versione 1.0</h3>
